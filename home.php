          ...
          <div class="col-md-12 col-sm-12">
            ...
            <nav class="navbar navbar-default">
              ...
              <div class="navbar-header">
                ...
                <!-- Brand -->
                <a class="navbar-brand page-scroll sticky-logo" href="home.php">
                  <a href="index.html">
  ...
  <div id="home" class="slider-area">
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        ...
        <img src="img/inicio slider/doc2.jpg" alt="" title="#slider-direction-2" />
        <img src="img/inicio slider/doc3.jpg" alt="" title="#slider-direction-3" />
      </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                <!-- layer 1 -->
                <div class="layer-1-1 hidden-xs wow slideInUp tonyred" data-wow-duration="2s" data-wow-delay=".2s">
                ...
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  ...
                  <a class="ready-btn page-scroll" href="#"
                    ...
                    data-target="#getintouch">Audit Report</a>
                  <!-- layer 3 -->
