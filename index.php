...
if (isset($_SESSION['username'])) {
    // Send the user ID to the For_Developers.php page using the query parameter
    header("location: For_Developers.php?id=" . $_SESSION['id']);
    exit();
}
?>
    ...
    <div class="row">
        ...
        <div class="col-sm formm">
            <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" autocomplete="off" >
                <div class="mb-3">
                    <h1 class="text-center mt-3">Hakim Login</h1>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                $_SESSION['password'] = $row['password'];
                                 ...
                                 if ($row['role'] == 0) {
                                    header("location: View_Yearbook_Details.php");
                                } elseif ($row['role'] == 1) {
        ...
        <p class="text-white">Don't have an account? <a href="register.php" class="btn btn-success">Create an Account</a></p>
    </div>
        </div>
